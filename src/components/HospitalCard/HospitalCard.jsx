    ...
    return (
        <Box sx={{ borderRadius: 2, bgcolor: "#fff", p: { xs: 2, md: 4 } }}>
            <Stack direction={{ xs: "column", md: "row"}} spacing={{ xs: 1, md: 4 }} flexWrap={"wrap"}>
                ...
                />
                <Box flex={1}>
                <Typography component="h3" color="#2AA7FF"
                    fontWeight={600}
                ...
                <Typography fontSize={14} mb={1} color="#414146" fontWeight={400}>
                    {details["Hospital Type"]}
                </Typography>
                <Stack direction="row" flexWrap="wrap" spacing="4px" mb={2}>
                    <Typography fontWeight={800} textTransform="uppercase" color="#02A401">Free</Typography>
